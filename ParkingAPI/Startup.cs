...
namespace ParkingAPI
{
    public class Startup
    {
        ...
        {
            services.Configure<carSetting>
                (Configuration.GetSection(nameof(carSetting)));
            services.AddSingleton<IcarSetting>
                (d => d.GetRequiredService<IOptions<carSetting>>().Value);
